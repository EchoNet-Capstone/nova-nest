...
class NestMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.central_widget.burd_map_overlay.map_view.markerClicked.connect(self.burd_status.toggle_visible)
        self.central_widget.burd_map_overlay.map_view.markerClicked.connect(self.burd_status.update_status)

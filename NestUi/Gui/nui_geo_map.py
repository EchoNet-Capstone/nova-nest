...
class MapBridge(QObject):
    """ Bridge between JavaScript (Folium) and PyQt. """
    markerClicked = Signal(str)  # Emits Buoy ID when clicked
...
def get_html_map(use_random_data=False):
    ...
    js_path = "NestUi/Utils/mapInteractions.js"  # Adjust path as needed.
